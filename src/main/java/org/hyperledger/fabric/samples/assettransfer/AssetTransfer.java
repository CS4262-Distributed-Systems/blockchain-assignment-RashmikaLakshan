...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Duplicate the asset and assign the duplicate to the new owner while keeping the original asset with the previous original owner.
     *
     * @param ctx        the transaction context
    ...
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String newOwner) {
        ...
        //duplicate asset ID
        String final newAssetId = "duplicate-" + assetID;

        //read current asset by id
